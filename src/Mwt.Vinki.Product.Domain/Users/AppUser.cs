...
namespace Mwt.Vinki.Product.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update ProductDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update ProductEfCoreEntityExtensionMappings to extend the IdentityUser entity
